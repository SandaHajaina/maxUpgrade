            ...
            <Container>
                ...
                <Box sx={{
                    ...
                    <Box sx={{
                        ...
                        <svg class="img-fluid" width="299" height="153" viewBox="0 0 299 153" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <Box sx={{
                        ...
                        <Typography variant='p' fontWeight={'bold'} textAlign={'left !important'}>
                            {t('value.description')}
                        </Typography>
                    </Box>
                </Box>
